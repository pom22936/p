...
<body>
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    ...
    <section class="jumbotron text-center" id="bg_sweet">
      <div class="container">
        <h1 class="jumbotron-heading">แนะนำร้านของหวานชื่อดัง</h1>
        <p class="lead text-muted" id="txt_b">แนะนำสถาที่ร้านของหวานที่น่ารับประทาน ร้านเด่น ร้านดัง ที่ต้องมาให้ได้ ในจังหวันหนองคาย ถ้าใครไม่มาแสดงว่ามาไม่ถึง
          อดชิมของหวานของจังหวัดใกล้ริมแม่น้ำโขงพร้อมบรรยากาศดีสบายๆ ของจังหวัดที่น่าอยู่เป็นอับดับต้นๆ ของประเทศไทย</p>
        <p>
          <a class="btn btn-lg btn-primary" href="sweetindex.php" role="button">ข้อมูลร้านเครื่องดืื่ม</a>
