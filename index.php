    ...
    <body >
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
          ...
          <div class="collapse navbar-collapse" id="navbarText">
            ...
            <ul class="navbar-nav">
              <li class="nav-item">
                <a class="nav-link fa fa-user-circle" href="register.php"> สมัครสมาชิก</a>
              </li>
              <li class="nav-item">
                <a class="nav-link fa fa-sign-in" href="fb_login.php"> ล็อกอิน</a>
              </li>
            </ul>
          </div>
        </nav>
          ...
          <div class="container" id="set">
            <div class="row">
                ...
                <div class="col-md-5 col-sm-7">
                  <img class="rounded-circle img-fluid" src="http://holytrinity.be/wp-content/uploads/2017/03/Bring-Share.jpg" alt="Generic placeholder image" style="width: 500px;height: 500px;">
                </div>
              </div>
          </div>
      </div>
          ...
          <div class="container" id="set">
              <div class="row">
                <div class="col-md-6 col-sm-6">
                  <img class="rounded-circle img-fluid" src="https://www.thairath.co.th/media/CiHZjUdJ5HPNXJ92GOy9Gimidj87q6btFo.jpg" alt="Generic placeholder image" style="width: 500px;height: 500px;">
                </div>
                <div class="col-md-6 col-sm-6">
            ...
            <div class="row">
              <div class="col-md-7 col-sm-7">
                ...
                <div class="col-md-5 col-sm-5">
                  <img class="rounded-circle img-fluid" src="https://sites.google.com/site/xahrthiy/_/rsrc/1472778025097/home/7-4.jpg" alt="Generic placeholder image" style="width: 500px;height: 500px;">
                </div>
              </div>
          </div>
      </div>
