    ...
    <h1>เพื่มข้อมูล</h1>
        <form action="insertdata.php" method="POST" enctype="multipart/form-data">
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="name" aria-describedby="name" placeholder="ชื่อร้าน">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="location" aria-describedby="location" placeholder="xxxxx">
            </div>
            <div class="form-group">
                <label for="tel">เบอร์โทรศัพท์</label>
                <input type="text" class="form-control" name="tel" aria-describedby="tel" placeholder="0xxxxxxxx">
            </div>
            <div class="form-group">
                <label for="web">Web ของร้านค้า</label>
                <input type="text" class="form-control" name="web" aria-describedby="web" >
            </div>
            <div class="row">
                <label>พิกัด</label>
                <div class="col">
                    <br>
                    <label>ละติจูด</label>
                    <input type="text" class="form-control" placeholder="ละติจูด" name="lat">
                </div>
                <div class="col">
                    <br>
                    <label>ลองติจูด</label>
                    <input type="text" class="form-control" placeholder="ลองติจูด" name="lng">
                </div>
            </div>
            ...
            <div class="row">
                <div class='col-sm-6'>
                    <div class="form-group">
                        ...
                        <div class='input-group date' id='datetimepicker3'>
                            <input type='time' class="form-control" name="opt"/>
                ...
                <div class='col-sm-6'>
                    <div class="form-group">
                        ...
                        <div class='input-group date' id='datetimepicker3'>
                            <input type='time' class="form-control" name="edt"/>
                            <span class="input-group-addon">
                                <span class="glyphicon glyphicon-time"></span>
                            </span>
                        </div>
            ...
            <div class="form-group">
                ...
                <label for="filUpload">รูปอาหาร</label>
                <input type="file" name="filUpload[]"  multiple="multiple">
            </div>
